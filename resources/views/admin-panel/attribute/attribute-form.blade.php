...
@section('title')
{{ __('Attributes') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('seller.index', [ app()->getlocale() ]) }}"
                                                class="text-muted">{{ __('Attributes') }}</a>
                                        </li>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Attributes') }}
                                ...
                                @if($attribute->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $attribute->id ] ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="type" placeholder="{{ __('Type') }}"
                                                                value="{{ $attribute->type ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('type') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="value" placeholder="{{ __('Value') }}"
                                                                value="{{ $attribute->value ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('value') : '' }}" />

                                                            @error('value')
                                                            <div class="fv-plugins-message-container invalid-feedback">
                                                                <div data-field="value" data-validator="notEmpty">
                                                                    {{ $message }}
                                                                </div>
                                                            </div>
                                                            @enderror
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select
                                                                ...
                                                                <option value="{{ $parentCategory->id }}"
                                                                    {{ $parentCategory->id == $attribute->category_id ? 'selected=selected' : '' }}>
                                                                    {{ $parentCategory->id }})
                                                                    {{ $parentCategory->{ 'name_' . app()->getlocale() } }}
                                                                </option>
                                                                @foreach($parentCategory->categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ $category->id == $attribute->category_id ? 'selected=selected' : '' }}>
                                                                    --
                                                                    ({{ $parentCategory->{ 'name_' . app()->getlocale() } }})
                                                                    > {{ $category->id }})
                                                                    {{ $category->{ 'name_' . app()->getlocale() } }} <
                                                                        ...
                                                                        <button type="submit"
                                                                            title="{{ $attribute->id ? __('Edit') : __('Create') }}"
                                                                            class="btn {{ $attribute->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                                            <span class="svg-icon svg-icon-md">
                                                                                @if($attribute->id)
                                                                                <span
                                                                                    class="svg-icon svg-icon-md {{ $attribute->id ? 'svg-icon-dark' : '' }}">
                                                                                ...
                                                                                <svg width="24px" height="24px"
                                                                                    ...
                                                                                    <title>Stockholm-icons / Code / Plus
                                                                                    </title>
                                                                            ...
                                                                            <span
                                                                                class="{{ $attribute->id ? 'text-dark' : '' }}">
                                                                                {{ $attribute->id ? __('Edit') : __('Create') }}
                                                                            </span>
                                                                        </button>
                                                        </div>
                                    </form>
