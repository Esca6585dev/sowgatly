        ...
        <div class="d-flex align-items-center">
            ...
            <button class="btn btn-hover-text-primary p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                <span class="svg-icon svg-icon-xl">
                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/attribute.svg-->
                                ...
                                <div class="d-flex align-items-baseline flex-wrap mr-5">
                                    ...
                                    <ul
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            <a href="{{ route('attribute.index', [ app()->getlocale() ]) }}" class="text-muted">{{ __('Attributes') }}</a>
                                        </li>
                                    </ul>
                                    <!--end::Breadcrumb-->
                                </div>
                            ...
                            <div class="card card-custom">
                                <div class="card-header flex-wrap py-5">
                                    <div class="card-title">
                                        <h3 class="card-label">{{ __('Attributes') }}</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin: Datatable-->
                                    @include('admin-panel.attribute.attribute-table')
                                    <!--end: Datatable-->
                                </div>
                            </div>
                            <!--end::Card-->
