                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($user->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $user->id ] ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $user->phone_number ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('phone_number') : '' }}" />
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $user->id ? __('Edit') : __('Create') }}"
                                                ...
                                                <span class="svg-icon svg-icon-md">
                                                    @if($user->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $user->id ? 'svg-icon-dark' : '' }}">
