...
@section('title')
{{ __('Address') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($address->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $address->id ] ) }}"
                                    ...
                                    <form action="{{ route(Request::segment(3) . '.store', [ app()->getlocale() ] ) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            <label>{{ __('address name') }}</label>

                                                            <input type="text"
                                                                class="form-control @error('name') is-invalid @enderror"
                                                                name="name" placeholder="{{ __('address name') }}"
                                                                value="{{ $address->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('first_name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $address->email ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('email') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $address->address ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('address') : '' }}" />
                                                        ...
                                                        <div class="col m-5">
                                                            <div class="image-input image-input-outline" id="kt_image_1"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset($address->image) }})">
                                                                </div>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $address->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $address->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($address->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $address->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $address->id ? 'text-dark' : '' }}">
                                                    {{ $address->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
