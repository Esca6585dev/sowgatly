...
@section('title')
{{ __('Regions') }} {{ __( ucfirst(request()->segment(count(request()->segments())))) }}
@endsection
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($region->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $region->id ] ) }}"
                                    ...
                                    <form action="{{ route(Request::segment(3) . '.store', [ app()->getlocale() ] ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="name" placeholder="{{ __('region name') }}"
                                                                value="{{ $region->name ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('first_name') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $region->email ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('email') : '' }}" />
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $region->address ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('address') : '' }}" />
                                                        ...
                                                        <div class="col m-5">
                                                            <div class="image-input image-input-outline" id="kt_image_1"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset($region->image) }})">
                                                                </div>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $region->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $region->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($region->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $region->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $region->id ? 'text-dark' : '' }}">
                                                    {{ $region->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
