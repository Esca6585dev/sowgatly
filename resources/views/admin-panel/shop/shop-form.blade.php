                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div class="card card-custom">
                                ...
                                @if($shop->id)
                                <form
                                    action="{{ route(Request::segment(3) . '.update', [ app()->getlocale(), $shop->id ] ) }}"
                                    ...
                                    <form action="{{ route(Request::segment(3) . '.store', [ app()->getlocale() ] ) }}"
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ $shop->email ?? '' }}{{ request()->segment(count(request()->segments())) == 'create' ? old('email') : '' }}" />
                                                        ...
                                                        <div class="col m-5">
                                                            <div class="image-input image-input-outline" id="kt_image_1"
                                                                ...
                                                                <div class="image-input-wrapper"
                                                                    style="background-image: url({{ asset($shop->image) }})">
                                                                </div>
                                        ...
                                        <div class="card-footer d-flex justify-content-between">
                                            ...
                                            <button type="submit" title="{{ $shop->id ? __('Edit') : __('Create') }}"
                                                class="btn {{ $shop->id ? 'btn-warning' : 'btn-primary' }} font-weight-bolder">
                                                <span class="svg-icon svg-icon-md">
                                                    @if($shop->id)
                                                    <span
                                                        class="svg-icon svg-icon-md {{ $shop->id ? 'svg-icon-dark' : '' }}">
                                                ...
                                                <span class="{{ $shop->id ? 'text-dark' : '' }}">
                                                    {{ $shop->id ? __('Edit') : __('Create') }}
                                                </span>
                                            </button>
                                        </div>
                                    </form>
