                                            ...
                                            <div class="card-spacer mt-n25">
                                                ...
                                                <div class="row m-0">
                                                    <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                                        <span
                                                            ...
                                                            <svg width="24px" height="24px" viewBox="0 0 24 24"
                                                                ...
                                                                <defs></defs>
                                                                <g id="Stockholm-icons-/-Shopping-/-Cart1" stroke="none"
                                                        ...
                                                        <a href="#Standards"
                                                            class="text-warning font-weight-bold font-size-h6">{{ __('Orders') }}</a>
                                                    </div>
                                                    <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                                        ...
                                                        <a href="{{ route('user.index', app()->getlocale() ) }}"
                                                            class="text-primary font-weight-bold font-size-h6 mt-2">{{ __('Users') }}
                                                            ({{ $users }})</a>
                                                    </div>
                                                </div>
                                                <!--end::Row-->
                                                ...
                                                <div class="row m-0">
                                                    <div class="col bg-light-secondary px-6 py-8 rounded-xl mr-7">
                                                        <span
                                                            class="svg-icon svg-icon-3x svg-icon-secondary d-block my-2">
                                                        ...
                                                        <a href="#Messages"
                                                            class="text-secondary font-weight-bold font-size-h6 mt-2">{{ __('Messages') }}</a>
                                                    </div>
                                                    <div class="col bg-light-success px-6 py-8 rounded-xl">
                                                        ...
                                                        <a href="#Applications"
                                                            class="text-success font-weight-bold font-size-h6 mt-2">{{ __('Applications') }}</a>
                                                    </div>
                                                </div>
                                                <!--end::Row-->
                                            </div>
