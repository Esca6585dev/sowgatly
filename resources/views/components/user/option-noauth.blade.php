<div class="main__section__image__option animate hide" id="image__option__{{ $id }}">
    <div class="main__section__image__option__top">
        <button class="main__section__image__option__top__btn" onclick="toggleOption({{ $id }})" id="close__{{ $id }}">
    ...
    <div class="main__section__image__option__menu">
        <ul class="main__section__image__option__menu__ul">
            <li class="main__section__image__option__menu__li">
                <img src="{{ asset('img/icon/Download.svg') }}" alt="{{ asset('img/icon/Download.svg') }}"
                    class="main__section__image__option__menu__li__icon">

                <span class="main__section__image__option__menu__li__name">
                    Download image
                </span>
            </li>
            <li class="main__section__image__option__menu__li">
