        ...
        <div class="forms">
            <div class="form login">
                ...
                <form method="POST" action="{{ route('admin.login', app()->getLocale()) }}">
                    ...
                    <div class="input-field">
                        <input type="text" placeholder="{{ __('Username') }}" class="@error('username') is-invalid @enderror" name="username" autocomplete="on" required value="{{ old('username') }}">
                ...
                <div class="login-signup">
                    <span class="text">
                        <a href="{{ route('main-page', app()->getlocale() ) }}" class="text signup-link">{{ env('APP_NAME') }}</a>
                    </span>
                </div>
            ...
            <div class="form signup">
                ...
                <form method="POST" action="{{ route('register', app()->getLocale()) }}">
                    ...
                    @enderror
                    <div class="input-field">
                        <input type="text" placeholder="{{ __('Email') }}" class="@error('email') is-invalid @enderror" name="email" autocomplete="on" required value="{{ old('email') }}" >
