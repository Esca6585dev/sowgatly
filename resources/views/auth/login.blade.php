        ...
        <div class="forms">
            <div class="form login">
                <div class="form-top">
                    ...
                    <a href="{{ route('main-page', app()->getlocale() ) }}">
                        <img src="{{ asset('img/logo/logo-white-2.png') }}" alt="{{ asset('img/logo/logo-white-2.png') }}" width="120px">
                    </a>
                </div>
                ...
                <form method="POST" action="{{ route('login', app()->getLocale()) }}">
                    ...
                    <div class="input-field">
                        <input type="text" placeholder="{{ __('Phone Number') }}" class="@error('phone_number') is-invalid @enderror" name="phone_number" autocomplete="on" required value="{{ old('phone_number') }}">
                        <i class="uil uil-envelope icon">
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Stockholm-icons-/-Devices-/-Phone" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                    <path opacity="0.50" d="M7.13888889,4 L7.13888889,19 L16.8611111,19 L16.8611111,4 L7.13888889,4 Z M7.83333333,1 L16.1666667,1 C17.5729473,1 18.25,1.98121694 18.25,3.5 L18.25,20.5 C18.25,22.0187831 17.5729473,23 16.1666667,23 L7.83333333,23 C6.42705272,23 5.75,22.0187831 5.75,20.5 L5.75,3.5 C5.75,1.98121694 6.42705272,1 7.83333333,1 Z" id="Combined-Shape" fill="#fa4d1e" fill-rule="nonzero"></path>
                                    <polygon id="Combined-Shape" fill="#fff" opacity="0.3" points="7 4 7 19 17 19 17 4"></polygon>
                                    <circle id="Oval" fill="#fff" cx="12" cy="21" r="1"></circle>
                                </g>
                            </svg>
                        </i>
                    </div>
                ...
                <div class="login-signup">
                    <span class="text">
                        <a href="{{ route('main-page', app()->getlocale() ) }}" class="text signup-link">{{ config('app.name') }}</a>
                    </span>
                </div>
            ...
            <div class="form signup">
                ...
                <div class="form-top" id="btnDIV">
                    <button class="btn btn_active" id="role1" data-myattribute="1" data-role-name="Alyjy">{{ __('Alyjy') }}</button>
                    <button class="btn" id="role2" data-myattribute="2" data-role-name="Satyjy">{{ __('Satyjy') }}</button>
                </div>
